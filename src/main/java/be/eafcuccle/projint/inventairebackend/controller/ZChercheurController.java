...
public class ZChercheurController {
    ...
    @PostMapping("/ajouter")
    public ResponseEntity<?> ajouterZChercheur(@RequestBody ZChercheur zchercheur, UriComponentsBuilder builder, Authentication authentication) {
        if(hasAuthority(authentication, "SCOPE_write:information")) {
            ...
            logger.debug("Accès refusé ! L'utilisateur n'a pas la permission d'ajouter un nouvel chercheur.");
    ...
    @GetMapping("/liste")
    public Page<ZChercheur> listeZChercheur(Pageable pageable, Authentication authentication) {
        if(hasAuthority(authentication, "SCOPE_read:information")){
            ...
            logger.debug("Accès refusé ! L'utilisateur n'a pas la permission d'accéder à la liste des chercheurs.");
            return null;
        }
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> supprimerZChercheur(@PathVariable int id, Authentication authentication) {
        if(hasAuthority(authentication, "SCOPE_write:information")){
    ...
    @GetMapping("/{id}")
    @ResponseBody
    public ResponseEntity<ZChercheur> detailZChercheur(@PathVariable int id, Authentication authentication) {
        if (hasAuthority(authentication, "SCOPE_read:information")) {
            ...
            logger.debug("Accès refusé ! L'utilisateur n'a pas la permission d'afficher les détails d'un chercheur.");
            return ResponseEntity.status(HttpStatus.FORBIDDEN).build();
        }
...
*/
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ZChercheur> modifierZChercheur(@PathVariable int id, @RequestBody ZChercheur updatedZChercheur, Authentication authentication) {
        if (hasAuthority(authentication, "SCOPE_read:information")) {
